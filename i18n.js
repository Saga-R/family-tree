...
(function () {
  const STR = {
    en: {
      ...
      welcome_generic_title: 'Welcome to the family tree',
      welcome_generic_sub: 'Browse 32 members across 5 families. If you\'re missing, tap "Add me" any time.',
      welcome_cta_add: 'Add my details →',
    ...
    hi: {
      ...
      welcome_generic_title: 'परिवार वृक्ष में आपका स्वागत है',
      welcome_generic_sub: '5 परिवारों के 32 सदस्यों को देखें। अगर आप नहीं हैं, कभी भी "मुझे जोड़ें" दबाएँ।',
      welcome_cta_add: 'अपनी जानकारी जोड़ें →',
